...
export module drivers.input:codes;

import std;

export namespace input
{
    enum input_prop : std::uint16_t
    {
        prop_pointer = 0x00,
        prop_direct = 0x01,
        prop_buttonpad = 0x02,
        ...
        prop_pressurepad = 0x07,
        prop_max = 0x1F,
        prop_cnt = prop_max + 1
    };

    enum ev_type : std::uint16_t
    {
        ev_syn = 0x00,
        ev_key = 0x01,
        ev_rel = 0x02,
