...
export namespace vfs::socket
{
    ...
    struct socket_t
    {
        ...
        virtual auto getsockname(lib::maybe_uspan<std::byte> out) -> lib::expect<std::size_t> = 0;
        virtual auto getpeername(lib::maybe_uspan<std::byte> out) -> lib::expect<std::size_t> = 0;
    ...
    using factory_fn = lib::expect<std::shared_ptr<socket_t>> (*)(sock_type type, int protocol);
