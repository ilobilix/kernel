...
namespace x86_64::syscall
{
    ...
    lib::syscall::entry<6, getter> table[]
    {
        ...
        [142] = { "sched_setparam", proc::sched_setparam },
        [143] = { "sched_getparam", proc::sched_getparam },
        [144] = { "sched_setscheduler", proc::sched_setscheduler },
        [145] = { "sched_getscheduler", proc::sched_getscheduler },
        [146] = { "sched_get_priority_max", proc::sched_get_priority_max },
        [147] = { "sched_get_priority_min", proc::sched_get_priority_min },
        [148] = { "sched_rr_get_interval", proc::sched_rr_get_interval },
        [149] = { "mlock", memory::mlock },
        [150] = { "munlock", memory::munlock },
        [151] = { "mlockall", memory::mlockall },
        [152] = { "munlockall", memory::munlockall },
        [153] = { "vhangup", misc::vhangup },
        [155] = { "pivot_root", vfs::pivot_root },
        [157] = { "prctl", misc::prctl, true },
        [158] = { "arch_prctl", arch::arch_prctl },
        [160] = { "setrlimit", proc::setrlimit },
        [161] = { "chroot", vfs::chroot },
        [162] = { "sync", vfs::sync },
        [164] = { "settimeofday", chrono::settimeofday },
        [165] = { "mount", vfs::mount },
        [166] = { "umount2", vfs::umount2 },
        ...
        [222] = { "timer_create", chrono::timer_create, true },
        [223] = { "timer_settime", chrono::timer_settime },
        [224] = { "timer_gettime", chrono::timer_gettime },
        [225] = { "timer_getoverrun", chrono::timer_getoverrun },
        [226] = { "timer_delete", chrono::timer_delete },
        [227] = { "clock_settime", chrono::clock_settime },
        ...
        [283] = { "timerfd_create", vfs::timerfd_create, true },
        [284] = { "eventfd", vfs::eventfd, true },
        [285] = { "fallocate", vfs::fallocate },
        [286] = { "timerfd_settime", vfs::timerfd_settime },
        [287] = { "timerfd_gettime", vfs::timerfd_gettime },
        ...
        [299] = { "recvmmsg", vfs::recvmmsg, true },
        [302] = { "prlimit", proc::prlimit },
        [307] = { "sendmmsg", vfs::sendmmsg, true },
