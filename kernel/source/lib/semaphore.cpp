...
namespace lib
{
    lib::intrusive_list_hook<sched::thread_base_t> &semaphore::locate::operator()(sched::thread_base_t &x)
    {
        static lib::intrusive_list_hook<sched::thread_base_t> a;
        return a;
        // return static_cast<sched::thread_t *>(std::addressof(x))->semaphore_list_hook;
    }
